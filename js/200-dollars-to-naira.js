...
if(localStorage.getItem("all_data_200")){
    
    console.log("data found");
    //get it and check for timestamp
    var p_data = JSON.parse(localStorage.getItem("all_data_200"));
 ...
 function loadApi()
     ...
     //   console.log(m6);
        ...
        //define urls
        var url1 = "https://api.exchangerate.host/"+today6+"?base=USD&symbols=USD,NGN&amount=200";
        var url2 = "https://api.exchangerate.host/"+today5+"?base=USD&symbols=USD,NGN&amount=200";
        var url3 = "https://api.exchangerate.host/"+today4+"?base=USD&symbols=USD,NGN&amount=200";
        var url4 = "https://api.exchangerate.host/"+today3+"?base=USD&symbols=USD,NGN&amount=200";
        var url5 = "https://api.exchangerate.host/"+today2+"?base=USD&symbols=USD,NGN&amount=200";
        var url6 = "https://api.exchangerate.host/"+today1+"?base=USD&symbols=USD,NGN&amount=200";
...
//console.log(data[8].data[0].sellingrate);
   ...
   //get timestamp
    ...
    all_data_200.push(addtime);
   
   //save data in ls
   localStorage.setItem("all_data_200", JSON.stringify(all_data_200));
...
var concrate = parseFloat(crate)*200;
  ...
  //display in dable
   ...
   // console.log("1:"+data[0].rates.NGN);
    ...
    //    console.log("locading from LS");
        //get the data
        data = JSON.parse(localStorage.getItem("all_data_200"));
