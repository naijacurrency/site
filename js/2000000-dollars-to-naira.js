...
//function for formating
  ...
  resultinput.innerHTML = format(result / 2000000);
}
...
if(localStorage.getItem("all_data_2000000")){
    
    console.log("data found");
    //get it and check for timestamp
    var p_data = JSON.parse(localStorage.getItem("all_data_2000000"));
    ...
    var d_timestamp = (n_timestamp - p_timestamp)/2000000/60/60;
 ...
 function loadApi()
     ...
     //   console.log(m6);
        ...
        //define urls
        var url1 = "https://api.exchangerate.host/"+today6+"?base=USD&symbols=USD,NGN&amount=2000000";
        var url2 = "https://api.exchangerate.host/"+today5+"?base=USD&symbols=USD,NGN&amount=2000000";
        var url3 = "https://api.exchangerate.host/"+today4+"?base=USD&symbols=USD,NGN&amount=2000000";
        var url4 = "https://api.exchangerate.host/"+today3+"?base=USD&symbols=USD,NGN&amount=2000000";
        var url5 = "https://api.exchangerate.host/"+today2+"?base=USD&symbols=USD,NGN&amount=2000000";
        var url6 = "https://api.exchangerate.host/"+today1+"?base=USD&symbols=USD,NGN&amount=2000000";
...
//console.log(data[8].data[0].sellingrate);
   ...
   //get timestamp
    ...
    all_data_2000000.push(addtime);
   
   //save data in ls
   localStorage.setItem("all_data_2000000", JSON.stringify(all_data_2000000));
...
var concrate = parseFloat(crate)*2000000;
...
const myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            label: '2000000 dollars to Naira exchange rate in the last 6 months',
  ...
  //display in dable
   ...
   // console.log("1:"+data[0].rates.NGN);
    ...
    //    console.log("locading from LS");
        //get the data
        data = JSON.parse(localStorage.getItem("all_data_2000000"));
...
var conbdisplay = blrate * 2000000;
console.log(conbdisplay);
