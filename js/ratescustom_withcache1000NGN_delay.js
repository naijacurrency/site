...
if(localStorage.getItem("all_data_1000N")){
    
    console.log("data found");
    //get it and check for timestamp
    var p_data = JSON.parse(localStorage.getItem("all_data_1000N"));
 ...
 function loadApi()
        ...
        //define urls
        var url1 = "https://api.exchangerate.host/"+today6+"?base=NGN&symbols=NGN,USD&amount=1000";
        var url2 = "https://api.exchangerate.host/"+today5+"?base=NGN&symbols=NGN,USD&amount=1000";
        var url3 = "https://api.exchangerate.host/"+today4+"?base=NGN&symbols=NGN,USD&amount=1000";
        var url4 = "https://api.exchangerate.host/"+today3+"?base=NGN&symbols=NGN,USD&amount=1000";
        var url5 = "https://api.exchangerate.host/"+today2+"?base=NGN&symbols=NGN,USD&amount=1000";
        var url6 = "https://api.exchangerate.host/"+today1+"?base=NGN&symbols=NGN,USD&amount=1000";
   ...
   //get timestamp
    ...
    all_data_1000N.push(addtime);
   
   //save data in ls
   localStorage.setItem("all_data_1000N", JSON.stringify(all_data_1000N));
   console.log(all_data_1000N);
...
const myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            label: '1000 Naira to dollars  exchange rate in the last 6 months',
            data: [data[0].rates.USD, data[1].rates.USD, data[2].rates.USD, data[3].rates.USD, data[4].rates.USD, data[5].rates.USD],
            backgroundColor: [
                'rgba(255, 99, 132, 0.2)',
                'rgba(54, 162, 235, 0.2)',
                'rgba(255, 206, 86, 0.2)',
...
//}
  ...
  //display in dable
   document.getElementById("mm1").innerHTML = m6;
    ...
    document.getElementById("mr1").innerHTML = data[0].rates.USD;
    document.getElementById("mr2").innerHTML = data[1].rates.USD;
     document.getElementById("mr3").innerHTML = data[2].rates.USD;
    document.getElementById("mr4").innerHTML = data[3].rates.USD;
     document.getElementById("mr5").innerHTML = data[4].rates.USD;
    document.getElementById("mr6").innerHTML = data[5].rates.USD;
    ...
    function loadLS(){
        ...
        //get the data
        data = JSON.parse(localStorage.getItem("all_data_1000N"));
