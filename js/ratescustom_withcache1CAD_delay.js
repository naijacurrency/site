...
document.getElementById("convcad").addEventListener("click",function(){
    
  //  console.log("running");
    
    //check if value to be converted is 0
    if(!document.getElementById("r1cad").value == 0){
    

//define cosntants
var firstinput = document.getElementById("r1cad");
var resultinput = document.getElementById("resultcad");
...
//get rate from LS
var cadrate = localStorage.getItem("cadtngn");

//remove coma
var newcadrate = cadrate.replace(/,(?=\d{3})/g, '')

//calculatev
var finalvalue = parseFloat(newcadrate) * from;
...
if(localStorage.getItem("all_data_cadtn")){
    
    console.log("data found");
    //get it and check for timestamp
    var p_data = JSON.parse(localStorage.getItem("all_data_cadtn"));
 ...
 function loadApi()
        ...
        //define urls
        var url1 = "https://api.exchangerate.host/"+today6+"?base=USD&symbols=CAD,NGN&amount=1";
        var url2 = "https://api.exchangerate.host/"+today5+"?base=USD&symbols=CAD,NGN&amount=1";
        var url3 = "https://api.exchangerate.host/"+today4+"?base=USD&symbols=CAD,NGN&amount=1";
        var url4 = "https://api.exchangerate.host/"+today3+"?base=USD&symbols=CAD,NGN&amount=1";
        var url5 = "https://api.exchangerate.host/"+today2+"?base=USD&symbols=CAD,NGN&amount=1";
        var url6 = "https://api.exchangerate.host/"+today1+"?base=USD&symbols=CAD,NGN&amount=1";
   ...
   //get timestamp
    ...
    all_data_cadtn.push(addtime);
   
   //save data in ls
   localStorage.setItem("all_data_cadtn", JSON.stringify(all_data_cadtn));
    ...
    */
    ...
    //display main rate
     document.getElementById("cadngn").innerHTML = format(data[6].result);
     
     //save in LS
    localStorage.setItem("cadtngn", data[6].result);
    //display date
...
const myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            label: '1 Canadian Dollar to Naira exchange rate in the last 6 months',
  ...
  //display in dable
   document.getElementById("mm1").innerHTML = m6;
    ...
    function loadLS(){
        ...
        //get the data
        data = JSON.parse(localStorage.getItem("all_data_cadtn"));
    ...
    //display main rate
     ...
     if(!localStorage.getItem("cadtngn")){
        //save in LS
    localStorage.setItem("cadtngn", data[6].result);
     }
