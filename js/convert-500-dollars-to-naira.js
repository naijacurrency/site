...
//function for formating
  ...
  resultinput.innerHTML = format(result / 500);
}
...
if(localStorage.getItem("all_data_500")){
    
    console.log("data found");
    //get it and check for timestamp
    var p_data = JSON.parse(localStorage.getItem("all_data_500"));
    ...
    var d_timestamp = (n_timestamp - p_timestamp)/500/60/60;
 ...
 function loadApi()
     ...
     //   console.log(m6);
        ...
        //define urls
        var url1 = "https://api.exchangerate.host/"+today6+"?base=USD&symbols=USD,NGN&amount=500";
...
//console.log(data[8].data[0].sellingrate);
   ...
   //get timestamp
    ...
    all_data_500.push(addtime);
   
   //save data in ls
   localStorage.setItem("all_data_500", JSON.stringify(all_data_500));
...
var concrate = parseFloat(crate)*500;
  ...
  //display in dable
   ...
   // console.log("1:"+data[0].rates.NGN);
    ...
    //    console.log("locading from LS");
        //get the data
        data = JSON.parse(localStorage.getItem("all_data_500"));
