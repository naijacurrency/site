...
var tagadsense = document.createElement("script");
tagadsense.src = "https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-2277594145415677";
tagadsense.crossorigin = "anonymous";
document.getElementsByTagName("head")[0].appendChild(tagadsense);


//add google analytics
var tage = document.createElement("script");
tage.src = "https://www.googletagmanager.com/gtag/js?id=G-XFZL8723RQ";
document.getElementsByTagName("head")[0].appendChild(tage);
...
//document.addEventListener("DOMContentLoaded", function() {
  ...
  var tagy = document.createElement("script");
tagy.src = "https://s7.addthis.com/js/300/addthis_widget.js#pubid=jetli004";
document.getElementsByTagName("body")[0].appendChild(tagy);
...
if(localStorage.getItem("all_data_50")){
    
    console.log("data found");
    //get it and check for timestamp
    var p_data = JSON.parse(localStorage.getItem("all_data_50"));
 ...
 function loadApi()
        ...
        //define urls
        var url1 = "https://api.exchangerate.host/"+today6+"?base=USD&symbols=USD,NGN&amount=50";
        var url2 = "https://api.exchangerate.host/"+today5+"?base=USD&symbols=USD,NGN&amount=50";
        var url3 = "https://api.exchangerate.host/"+today4+"?base=USD&symbols=USD,NGN&amount=50";
        var url4 = "https://api.exchangerate.host/"+today3+"?base=USD&symbols=USD,NGN&amount=50";
        var url5 = "https://api.exchangerate.host/"+today2+"?base=USD&symbols=USD,NGN&amount=50";
        var url6 = "https://api.exchangerate.host/"+today1+"?base=USD&symbols=USD,NGN&amount=50";
   ...
   //get timestamp
    ...
    all_data_50.push(addtime);
   
   //save data in ls
   localStorage.setItem("all_data_50", JSON.stringify(all_data_50));
...
const myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            label: '50 dollars to Naira exchange rate in the last 6 months',
  ...
  //display in dable
   document.getElementById("mm1").innerHTML = m6;
    ...
    function loadLS(){
        ...
        //get the data
        data = JSON.parse(localStorage.getItem("all_data_50"));
