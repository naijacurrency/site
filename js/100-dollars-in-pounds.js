...
document.addEventListener("DOMContentLoaded",function(){
	...
	setTimeout(function(){var tag=document.createElement("script");
...
if(localStorage.getItem("all_data_100")){
	console.log("data found");
var p_data=JSON.parse(localStorage.getItem("all_data_100"));
var p_timestamp=parseFloat(p_data[7].timestamp);
var n_timestamp=Date.now();
var d_timestamp=(parseFloat(n_timestamp)-p_timestamp)/100/60/60;
...
function format(n,sep,decimals){sep=sep||".";decimals=decimals||2;return n.toLocaleString().split(sep)[0]
+sep
+n.toFixed(decimals).split(sep)[1];}
...
var url1="https://openexchangerates.org/api/historical/"+today6+".json?app_id="+app_id+"&symbols=NGN,GBP";
var url2="https://openexchangerates.org/api/historical/"+today5+".json?app_id="+app_id+"&symbols=NGN,GBP";
var url3="https://openexchangerates.org/api/historical/"+today4+".json?app_id="+app_id+"&symbols=NGN,GBP";
var url4="https://openexchangerates.org/api/historical/"+today3+".json?app_id="+app_id+"&symbols=NGN,GBP";
var url5="https://openexchangerates.org/api/historical/"+today2+".json?app_id="+app_id+"&symbols=NGN,GBP";
var url6="https://openexchangerates.org/api/historical/"+today1+".json?app_id="+app_id+"&symbols=NGN,GBP";
var url7="https://openexchangerates.org/api/latest.json?app_id=2811fd1ec0024160ab4d4f63316e1730&symbols=NGN,GBP";
...
document.getElementById("conc").innerHTML=format(data[6].rates.GBP);
document.getElementById("rat").innerHTML=format(data[6].rates.GBP);

var conbdispla=blrate*100;
var conbdisplay=conbdispla.toLocaleString();
//document.getElementById("ratb").innerHTML=conbdisplay;
document.getElementById("ratc").innerHTML=format(data[8].rates.GBP);
var gbrate=parseFloat(data[9].price);
var gate=gbrate+(0.0*gbrate);
console.log(gate);
console.log(blrate);
var gbp2GBP=gate*blrate;
var grate=gbp2GBP.toFixed(2);
document.getElementById("pou").innerHTML=grate;
