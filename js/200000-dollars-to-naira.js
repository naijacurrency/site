...
if(localStorage.getItem("all_data_200000")){
    
    console.log("data found");
    //get it and check for timestamp
    var p_data = JSON.parse(localStorage.getItem("all_data_200000"));
...
//console.log(data[8].data[0].sellingrate);
   ...
   //get timestamp
    ...
    all_data_200000.push(addtime);
   
   //save data in ls
   localStorage.setItem("all_data_200000", JSON.stringify(all_data_200000));
  ...
  document.getElementById("mr5").innerHTML = data[4].rates.NGN*amount_to_change;
   document.getElementById("mr6").innerHTML = data[5].rates.NGN*amount_to_change;
    ...
    //    console.log("locading from LS");
        //get the data
        data = JSON.parse(localStorage.getItem("all_data_200000"));
