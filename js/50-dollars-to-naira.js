...
//function for formating
  ...
  resultinput.innerHTML = format(result / 50);
}
...
if(localStorage.getItem("all_data_50")){
    ...
    var d_timestamp = (n_timestamp - p_timestamp)/50/60/60;
...
var concrate = parseFloat(crate)*50;
