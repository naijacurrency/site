...
//function for formating
 ...
 document.getElementById("btcusd").innerHTML = format(data[6].result);
...
//for specific calculator

document.getElementById("convbtc").addEventListener("click",function(){
    
  //  console.log("running");
    
    //check if value to be converted is 0
    if(!document.getElementById("r1btc").value == 0){

var firstinput = document.getElementById("r1btc");
var resultinput = document.getElementById("resultbtc");
...
//get rate from LS
var btcrate = localStorage.getItem("btcv");

//remove coma
var newbtcrate = btcrate.replace(/,(?=\d{3})/g, '')

//calculatev
var finalvalue = parseFloat(newbtcrate) * from;


//display result
resultinput.innerHTML = format(finalvalue);
...
if(localStorage.getItem("all_data_btc")){
    
    console.log("data found");
    //get it and check for timestamp
    var p_data = JSON.parse(localStorage.getItem("all_data_btc"));
 ...
 function loadApi()
        ...
        //define urls
        var url1 = "https://api.exchangerate.host/"+today6+"?base=USD&symbols=BTC,USD&amount=1";
        var url2 = "https://api.exchangerate.host/"+today5+"?base=USD&symbols=BTC,USD&amount=100";
        var url3 = "https://api.exchangerate.host/"+today4+"?base=USD&symbols=BTC,USD&amount=100";
        var url4 = "https://api.exchangerate.host/"+today3+"?base=USD&symbols=BTC,USD&amount=100";
        var url5 = "https://api.exchangerate.host/"+today2+"?base=USD&symbols=BTC,USD&amount=100";
        var url6 = "https://api.exchangerate.host/"+today1+"?base=USD&symbols=BTC,USD&amount=100";
   ...
   //get timestamp
    ...
    all_data_btc.push(addtime);
   
   //save data in ls
   localStorage.setItem("all_data_btc", JSON.stringify(all_data_btc));
    ...
    */
    ...
    //display main rate
     document.getElementById("btcusd").innerHTML = format(data[6].result);
     //save in LS
     var btcusdvalue = localStorage.setItem("btcv", data[6].result);
    //display date
...
const myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            label: '1 Bitcoin to US dollars exchange rate in the last 6 months',
            data: [data[0].rates.BTC, data[1].rates.BTC, data[2].rates.BTC, data[3].rates.BTC, data[4].rates.BTC, data[5].rates.BTC],
            backgroundColor: [
                'rgba(255, 99, 132, 0.2)',
                'rgba(54, 162, 235, 0.2)',
                'rgba(255, 206, 86, 0.2)',
...
//}
  ...
  //display in dable
   document.getElementById("mm1").innerHTML = m6;
    ...
    document.getElementById("mr1").innerHTML = data[0].rates.BTC;
    document.getElementById("mr2").innerHTML = data[1].rates.BTC;
     document.getElementById("mr3").innerHTML = data[2].rates.BTC;
    document.getElementById("mr4").innerHTML = data[3].rates.BTC;
     document.getElementById("mr5").innerHTML = data[4].rates.BTC;
    document.getElementById("mr6").innerHTML = data[5].rates.BTC;
    ...
    function loadLS(){
        ...
        //get the data
        data = JSON.parse(localStorage.getItem("all_data_btc"));
