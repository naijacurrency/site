...
if(localStorage.getItem("all_data")){
    ...
    var p_data = JSON.parse(localStorage.getItem("all_data"));
 ...
 function loadApi()
        ...
        //define urls
        var url1 = "https://api.exchangerate.host/"+today6+"?base=USD&symbols=USD,NGN&amount=2000";
        var url2 = "https://api.exchangerate.host/"+today5+"?base=USD&symbols=USD,NGN&amount=2000";
        var url3 = "https://api.exchangerate.host/"+today4+"?base=USD&symbols=USD,NGN&amount=2000";
        var url4 = "https://api.exchangerate.host/"+today3+"?base=USD&symbols=USD,NGN&amount=2000";
        var url5 = "https://api.exchangerate.host/"+today2+"?base=USD&symbols=USD,NGN&amount=2000";
        var url6 = "https://api.exchangerate.host/"+today1+"?base=USD&symbols=USD,NGN&amount=2000";
...
const myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            label: '2000 dollars to Naira exchange rate in the last 6 months',
